...
import { loadUsers, loadProducts, loadUsersToDelete } from '../script/main-script';
        ...
        <nav className="header-nav navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
          ...
          <div className="collapse navbar-collapse">
              ...
              <li className="nav-item active">
                  <a className="nav-link" href="/user/user.html">Home</a> 
              </li>
...
export {AdminNavbar, UsersTable, UserUpdate, UserToDeleteTable, ProductsTable, Modals};